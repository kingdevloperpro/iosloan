package com.face.livechat.vcall.gopu_fagansds;
...
public class gopu_moriya {
    ...
    public gopu_moriya(Activity activity2) {
    ...
    public static void alertDialog(Activity activity2, int i, DialogCreated dialogCreated) {
        new gopu_moriya(activity2).listener = dialogCreated;
    ...
    public static void dialogCommon(Activity activity2, final String str, final String str2) {
        alertDialog(activity2, R.layout.saturday_special_karotu, new DialogCreated() {
    ...
    public static void progressDialogShow1(Activity activity2) {
        try {
            ...
            dialog1 = dialog2;
            dialog2.setContentView(R.layout.saturday_special_hanumante);
    ...
    public static void dialogServerError(Activity activity2) {
        alertDialog(activity2, R.layout.saturday_special_sutanama, new DialogCreated() {
    ...
    public static void dialogNoInternet(final Activity activity2, final boolean z) {
        alertDialog(activity2, R.layout.saturday_special_atulit, new DialogCreated() {
