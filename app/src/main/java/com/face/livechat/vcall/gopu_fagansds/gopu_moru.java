...
public class gopu_moru extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "myDatabase";
    private static final int DATABASE_VERSION = 1;

    public gopu_moru(Context context) {
    ...
    public void addLoan(gopu_hellodasA SFLoanLnDt) {
