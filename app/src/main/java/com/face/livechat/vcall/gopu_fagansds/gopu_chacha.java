...
public class gopu_chacha {
    public static String SPIN = "10";
    public static SharedPreferences _sharedPreferences;
    private Activity activity;

    public gopu_chacha(Activity activity2) {
        this.activity = activity2;
    }

    public static SharedPreferences sharedPreferences() {
        SharedPreferences sharedPreferences = Loan_MBit.getContext().getSharedPreferences("PrefData", 0);
    ...
    public static Bitmap getSelfie() {
        if (!sharedPreferences().contains("selfie")) {
            return BitmapFactory.decodeResource(Loan_MBit.getContext().getResources(), R.drawable.ic_default_user);
        }
