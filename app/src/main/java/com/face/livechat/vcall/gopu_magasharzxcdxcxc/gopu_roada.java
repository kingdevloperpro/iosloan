...
public class gopu_roada extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.saturday_special_bhanjanay);
        ...
        if (isOnline()) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    gopu_roada.this.progressDialog.isShowing();
                    gopu_roada.this.progressDialog.dismiss();
                }
            }, 3000);
        }
        ...
        cvDial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((ClipboardManager) gopu_roada.this.getSystemService("clipboard")).setPrimaryClip(ClipData.newPlainText("Bank Balance Check Number :", gopu_roada.this.tvNumber.getText().toString()));
                Toast.makeText(gopu_roada.this.getApplicationContext(), "Number Copied to clipboard... Please dial number in your dial pad", 0).show();
            }
        });
    }
