...
import static com.face.livechat.vcall.gopu_chtr.gopu_hant.getGeoApiService;
...
import com.face.livechat.vcall.gopu_chtr.gopu_kaka;
import com.face.livechat.vcall.gopu_chtr.gopu_mama;
...
public abstract class SplashBaseActivity extends AppCompatActivity {
    ...
    private void verifyUser(List<LocArray> locArray) {
        gopu_mama apiService = getGeoApiService();
        apiService.getLocation().enqueue(new Callback<gopu_kaka>() {
            @Override
            public void onResponse(Call<gopu_kaka> call, Response<gopu_kaka> response) {
            ...
            @Override
            public void onFailure(Call<gopu_kaka> call, Throwable t) {
