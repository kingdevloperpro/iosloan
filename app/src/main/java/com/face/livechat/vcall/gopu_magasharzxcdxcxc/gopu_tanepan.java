...
public class gopu_tanepan extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.saturday_special_jayho);
        ...
        if (isOnline()) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    gopu_tanepan.this.progressDialog.isShowing();
                    gopu_tanepan.this.progressDialog.dismiss();
                }
            }, 3000);
        }
        int i = 0;
    ...
    public class C3021a extends RecyclerView.Adapter<C3021a.C3020a> {
        final gopu_tanepan f12897a;

        public C3021a(gopu_tanepan iFSCListActivityVB) {
            this.f12897a = iFSCListActivityVB;
        }

        public C3020a m16686a(ViewGroup viewGroup, int i) {
            return new C3020a(this, LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.saturday_special_swaaa, (ViewGroup) null));
        }
