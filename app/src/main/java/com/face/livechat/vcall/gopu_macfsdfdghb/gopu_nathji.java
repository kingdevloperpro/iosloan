...
public class gopu_nathji extends AppCompatActivity {
    TextView editext;
    TextView editext10;
    TextView editext100;
    TextView editext20;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.saturday_special_hanuma);
        ...
        TextWatcher r2 = new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                gopu_nathji VBCashCountActs = gopu_nathji.this;
        ...
        imgshare.setOnClickListener(new gopu_saruche() {
            @Override
        ...
        imgadd.setOnClickListener(new gopu_saruche() {
            @Override
            public void performClick(View v) {
                gopu_nathji VBCashCountActs = gopu_nathji.this;
        ...
        imgminus.setOnClickListener(new gopu_saruche() {
            @Override
            public void performClick(View v) {
                gopu_nathji VBCashCountActs = gopu_nathji.this;
                VBCashCountActs.numberOfTaps = Integer.parseInt(VBCashCountActs.editext.getText().toString()) - 1;
