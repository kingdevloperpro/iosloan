...
import com.face.livechat.vcall.gopu_low;
...
public class gopu_amthoamtho extends AppCompatActivity implements View.OnClickListener {
...
//        txtShare.setOnClickListener(new C30254(this));
        txtShare.setOnClickListener(new gopu_low() {
            @Override
    ...
    public void onClick(View view) {
        Intent intent = new Intent(this, gopu_tanepan.class);
        switch (view.getId()) {
            case R.id.txtBank:
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.saturday_special_namo);

        activity = gopu_amthoamtho.this;
        ...
        if (isOnline()) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    gopu_amthoamtho.this.progressDialog.isShowing();
                    gopu_amthoamtho.this.progressDialog.dismiss();
                }
            }, 3000);
        }
    ...
    public void ironfullscreen(final int i) {
        ...
        gopu_amthoamtho.this.progressBar.dismiss();
        gopu_amthoamtho.this.click(i);
    }
    ...
    class C30221 implements Runnable {
        final gopu_amthoamtho f12907a;

        C30221(gopu_amthoamtho iFSCbankListActivityVB) {
    ...
    public class C30232 implements View.OnClickListener {
        final gopu_amthoamtho f12908a;

        C30232(gopu_amthoamtho iFSCbankListActivityVB) {
    ...
    public class C30243 implements View.OnClickListener {
        final gopu_amthoamtho f12909a;

        C30243(gopu_amthoamtho iFSCbankListActivityVB) {
    ...
    public class C30254 implements View.OnClickListener {
        final gopu_amthoamtho f12910a;

        C30254(gopu_amthoamtho iFSCbankListActivityVB) {
    ...
    class C30265 implements View.OnClickListener {
        final gopu_amthoamtho f12911a;

        C30265(gopu_amthoamtho iFSCbankListActivityVB) {
